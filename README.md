...
1. [View the contents of the menu](Посмотреть-содержимое-меню)
2. [Make a new order](Создать-заказ)
3. [Interaction with my orders](Взаимодействие-с-моими-заказами)
4. [Reviews](Отзывы)
...
3. Если пользователь ввел ``2``, то у него будет возможность удалить анее опубликованный отзыв о каком-то блюде.
## Содержание работы
