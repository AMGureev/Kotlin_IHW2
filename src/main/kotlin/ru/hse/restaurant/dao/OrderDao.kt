...
interface OrderDao {
    ...
    fun returnRevenue(): Double
    fun returnOrdersByUser(login: String): List<OrderEntity>
    fun addDishToOrder(order: OrderEntity, dish: DishEntity)
    fun fillingOrdersData()
    fun saveAllOrders()
    fun returnAllOrders(): List<OrderEntity>
}